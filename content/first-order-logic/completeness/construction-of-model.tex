...
\tagitem{prvNot}{%
  \indcase{!A}{\lnot !B}
    ...
    iff $\iftag{FOL}{\Sat/{M(\Gamma^*)}{!B}}{\pSat{v(\Gamma^*)}{!B}}$ (by definition of satisfaction). By
    induction hypothesis, $\Sat/{M(\Gamma^*)}{!B}$ iff $!B \notin
    \Gamma^*$. Since $\Gamma^*$ is consistent and !!{complete}, $!B
...
\iftag{probOr}{%
  ...
  \indcase{!A}{!B \lor !C}
    {$\iftag{FOL}{\Sat{M(\Gamma^*)}}{\pSat{v(\Gamma^*)}}{\indfrm}$
    iff at $\iftag{FOL}{\Sat{M(\Gamma^*)}}{\pSat{v(\Gamma^*)}}{!B}$ or
    $\iftag{FOL}{\Sat{M(\Gamma^*)}}{\pSat{v(\Gamma^*)}}{!C}$ (by
