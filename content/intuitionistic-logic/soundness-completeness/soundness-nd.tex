...
\begin{prob}
Show that the following formulas are not derivable in intuitionistic logic, i.e., $\Proves/ !A$:
\begin{enumerate}
  \item $(!B \lif !C) \lor (!C \lif !B)$
  \item$(\lnot\lnot !B \lif !B) \lif (!B \lor \lnot !B)$
\end{enumerate}
\end{prob}
